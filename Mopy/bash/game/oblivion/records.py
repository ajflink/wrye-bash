...
from ...brec import MelRecord, MelGroups, MelStruct, FID, MelGroup, \
    ...
    MreHeaderBase, MelBase, MelStrings, \
...
class MreDial(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelArray(u'quests2', MelFid(b'QSTR')), # xEdit calls it 'Quests?'
        MelFull(),
...
class MreDoor(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelGroups(u'destinations', MelFid(b'TNAM')),
    )
    __slots__ = melSet.getSlotsUsed()
...
class MreNpc(MreActorBase):
    ...
    melSet = MelSet(
        ...
        MelScript(),
        MelItems(),
        MelStruct(b'AIDT', [u'4B', u'I', u'b', u'B', u'2s'], ('aggression', 5),
                  ('confidence', 50), ('energyLevel', 50),
                  ('responsibility', 50), (aiService, u'services'),
                  'trainSkill', 'trainLevel', 'unused1'),
        MelGroups(u'aiPackages', MelFid(b'PKID')),
        MelStrings(b'KFFZ','animations'),
