...
from ...brec import MelRecord, MelObject, MelGroups, MelStruct, FID, \
    ...
    MelOptStruct, MreHeaderBase, MelBase, \
...
class MelItemsCounter(MelCounter):
    ...
    def __init__(self):
        MelCounter.__init__(
            self, MelUInt32(b'COCT', 'item_count'), counts='items')
    ...
    def __init__(self):
        MelSequential.__init__(self,
            MelCounter(MelUInt32(b'KSIZ', u'keyword_count'),
                       counts=u'keywords'),
            MelArray(u'keywords', MelFid(b'KWDA')),
        )
...
class MreArma(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelFid(b'NAM2', 'skin2'),
        MelFid(b'NAM3', 'skin3'),
        MelGroups(u'races', MelFid(b'MODL')),
...
class MreClmt(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelArray('weatherTypes',
            MelStruct(b'WLST', [u'I', u'i', u'I'], (FID, u'weather'), u'chance',
                      (FID, u'global')),
        ),
...
class MreColl(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelArray(u'collidesWith', MelFid(b'CNAM')),
    )
    __slots__ = melSet.getSlotsUsed()
...
class MreLtex(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelGroups(u'grasses', MelFid(b'GNAM')),
...
class MreNpc(MreActorBase):
    ...
    melSet = MelSet(
        ...
        MelGroups(u'head_part_addons', MelFid(b'PNAM')),
...
class MreOtft(MelRecord):
    ...
    melSet = MelSet(
        MelEdid(),
        MelArray(u'items', MelFid(b'INAM')),
    )
    __slots__ = melSet.getSlotsUsed()
...
class MreRefr(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelGroup('roomData',
            MelStruct(b'XRMR', [u'B', u'B', u'2s'], u'linkedRoomsCount',
        ...
        MelGroups('linkedReference',
            MelStruct(b'XLKR', [u'2I'], (FID, 'keywordRef'), (FID, 'linkedRef')),
        ),
        MelGroup('patrolData',
    ...
    melSet = MelSet(
        ...
        MelGroups('entries',
            ...
            MelRegnEntrySubrecord(7, MelArray('sounds',
                MelStruct(b'RDSA', [u'2I', u'f'], (FID, 'sound'), (sdflags, 'flags'),
                          'chance'),
            )),
...
class MreWthr(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelGroups(u'skyStatics', MelFid(b'TNAM')),
